...
/**
 * created pushpak on 18/07/2016
 */
public class AirflowTermStep {
    private static final Logger LOGGER = Logger.getLogger(AirflowTermStep.class);

    /**
     * default constructor
     */
    private AirflowTermStep() {
    ...
    public static void main(String[] args) {
        ...
        try {
            airflowUtil.persistBeanData(termStepInfo, false);
        } catch (Exception e) {
            LOGGER.error(e);
