 ...
 */
public class AirflowInitStep {
    private static final Logger LOGGER = Logger.getLogger(AirflowInitStep.class);

    /**
     * default constructor
     */
    private AirflowInitStep() {
    ...
    public static void main(String[] args) {
        ...
        try {
            airflowUtil.persistBeanData(initStepInfo, false);
        } catch (Exception e) {
            LOGGER.error(e);
