 ...
 */
public class StatusHandlerCrawlController extends BaseStructure {
    ...
    public static void main(String[] args) throws Exception {
        CommandLine commandLine = new StatusHandlerCrawlController().getCommandLine(args, PARAMS_STRUCTURE);
