 ...
 */
public class BasicCrawlController implements Runnable {
...
//      PropertyConfig.setParams(pid, "crawlConfig");
        ...
        if (propertyConfig.getProxyHost() != null) {
            ...
            if (propertyConfig.getProxyPort() != 0) {
                config.setProxyPort(propertyConfig.getProxyPort());
                if (propertyConfig.getProxyUserName() != null) {
                    config.setProxyUsername(propertyConfig.getProxyUserName());
                    if (propertyConfig.getProxyPassword() != null) {
                        config.setProxyPassword(propertyConfig.getProxyPassword());
                    }
                }
            }
        }
