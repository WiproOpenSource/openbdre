...
public class MetadataPersistenceTrigger implements PreUpdateEventListener, PreInsertEventListener, PostUpdateEventListener, PostInsertEventListener {
    ...
    static {
        ...
        processTypeMap.put(81,41);
        processTypeMap.put(82,41);
        processTypeMap.put(83,41);
        processTypeMap.put(84,41);
        processTypeMap.put(85,41);
        processTypeMap.put(86,0);
        processTypeMap.put(87,86);
        processTypeMap.put(88,86);
        processTypeMap.put(89,86);
        processTypeMap.put(90,86);
        processTypeMap.put(102,41);
        processTypeMap.put(103,0);
        processTypeMap.put(104,103);
        processTypeMap.put(105,103);
        processTypeMap.put(106,103);
        processTypeMap.put(107,103);
        processTypeMap.put(108,103);
        processTypeMap.put(109,103);
        processTypeMap.put(110,103);
        processTypeMap.put(111,103);
        processTypeMap.put(112,103);
        processTypeMap.put(113,103);
        processTypeMap.put(114,103);
    }
