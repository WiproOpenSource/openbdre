...
<script>
	...
	function redirectToLogin(workspaceName) {
	  window.location = "/auth_" + workspaceName + "/bdre/security/login.page";
	}
</script>
</head>
	
<body onload='document.workspaceForm.workspace.focus();' class="blue-bg">
	<div id="container">
	...
	<!-- <img id="logo" class="center-block img-responsive logo" src="css/images/Wipro-logo.png"/> -->
		...
		<div class="alert alert-danger login-alert-danger " role="alert">
		    ...
		    <span class="sr-only">Page Error</span>
		    ${error}
		</div>
		</c:if>
		...
		<div class="alert alert-info " role="alert">
		    ...
		    <span class="sr-only">Page Info</span>
		    ${msg}
		</div>
	    </c:if>
		<form name='workspaceForm' class="loginForm">
		    <div class="form-group has-success has-feedback">
		        <div class="input-group">
		        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
		        	<!-- <input id="InputWorkspace" name='workspace' placeholder="Workspace Name" type="text" class="form-control"> -->
					<select id="InputWorkspace" name='workspace' class="form-control">
			...
			<div class="login-links">
				<button type="button" class="btn btn-lg btn-primary btn-block btn-signin"
					onClick="redirectToLogin(document.workspaceForm.InputWorkspace.value)">Chooose Workspace</button>
				<div class="clearfix"></div>
			</div>
