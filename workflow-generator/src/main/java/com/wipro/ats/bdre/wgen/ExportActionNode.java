 ...
 */
public class ExportActionNode extends GenericActionNode {
     ...
     */
    public ExportActionNode(ActionNode actionNode) {
    ...
    public String getName() {
        ...
        String nodeName = "export-" + getId() + "-" + processInfo.getProcessName().replace(' ', '_');
    ...
    public String getXML() {
        ...
        ret.append("\n<action name=\"" + getName() + "\">\n" +
                ...
                "            <main-class>com.wipro.ats.bdre.dataexport.DataExportMain</main-class>\n" +
