...
public class CreateTableActionNode extends GenericActionNode {
     ...
     */
    public CreateTableActionNode(ActionNode actionNode) {
    ...
    public String getName() {
        String nodeName = "create-tables-" + getId() + "-" + processInfo.getProcessName().replace(' ', '_');
