...
public class SFTPNonOozieActionNode extends GenericActionNode {
     ...
     */
    public SFTPNonOozieActionNode(ActionNode actionNode) {
    ...
    public String getName() {
        ...
        String nodeName = "sftp-" + getId() + "-" + processInfo.getProcessName().replace(' ', '_');
    ...
    public String getXML() {
        ...
        ret.append("<fake-action></fake-action>");
