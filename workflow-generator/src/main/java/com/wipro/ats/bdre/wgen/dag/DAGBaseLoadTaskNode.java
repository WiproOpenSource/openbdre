 ...
 */
public class DAGBaseLoadTaskNode extends GenericActionNode {
    private static final Logger LOGGER = Logger.getLogger(DAGBaseLoadTaskNode.class);
     ...
     */
    public DAGBaseLoadTaskNode(DAGTaskNode taskNode) {
