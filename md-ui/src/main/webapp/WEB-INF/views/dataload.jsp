...
wizard = $(document).ready(function() {
	$("#bdre-data-load").steps({
		...
		onStepChanging: function(event, currentIndex, newIndex) {
			console.log(currentIndex + 'current ' + newIndex + 'process Name' + document.getElementById('processFieldsForm1').elements[0].value);
		...
		<script type="text/javascript">
            ...
            $(".add-more").click(function(e){
                ...
                newIn = newIn +  '<input type="text" class="form-control input-sm" id="colName.' + next + '" value="" name="colName.' + next + '" placeholder="Column Name" />' ;
                newIn = newIn +  '</div>' ;
                newIn = newIn +  '<div class="col-md-3">' ;
                newIn = newIn +  '<input type="text" class="form-control input-sm" id=dataType.' + next + '" value="" name="dataType.' + next + '" placeholder="Data Type" />' ;
                newIn = newIn +  '</div>' ;
...
<form class="form-horizontal" role="form" id="processFieldsForm1">
			...
			<section>
                        <form class="form-horizontal" role="form" id="rawTableColumn">
                            <div id="rawTablecolumnDetails">
                                ...
                                <div class="form-group" id="formGroup1" >
                                    <div class="col-md-3">
                                        <input type="text" class="form-control input-sm" id="colName.1" value="" name="colName.1" placeholder="Column Name" />
                                    </div>
                                    <div class="col-md-3">
                                        <input type="text" class="form-control input-sm" id="dataType.1" value="" name="dataType.1" placeholder="Data Type" />
                                    </div>
