...
<head>
  ...
  <body ng-app="myApp" ng-controller="myCtrl">
  						<div class="page-header">Kafka</div>
                        <div class="row">&nbsp;</div>
                        <div class="row">
                                ...
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body">
                                        <form role="form" id="propertiesFieldsForm" novalidate="novalidate">
                                            ...
                                            <div class="form-group">
                                                <label >ZooKeeper Connection String</label>
                                                <input type="text" class="form-control" name="zkConnectionString" value="localhost:2181" required>
                                            </div>
                                            <div class="form-group">
                                                <label >Brokers List</label>
                                                <input type="text" class="form-control" name="brokersList" value="localhost:9092" required>
                                            </div>
                                            <div class="form-group">
                                                <label >Process Name</label>
                                                <input type="text" class="form-control" name="processName"  required>
                                            </div>

                                            <div class="form-group">
                                                <label >Process Description</label>
                                                <input type="text" class="form-control" name="processDesc"  required>
                                            </div>
               ...
               $("#successHeader").hide();
                        ...
                        $scope.busDomains = {};
                                ...
                                $scope.createJob =function (){
                                 formIntoMap('properties_', 'propertiesFieldsForm');

                                $.ajax({

                                                        type: "POST",
                                                        url: "/mdrest/kafkaproducer/createjobs",
