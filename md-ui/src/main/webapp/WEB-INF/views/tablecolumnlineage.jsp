<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    <%@taglib uri="http://www.springframework.org/tags" prefix="spring" %>
        <%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %>
            ...
            <title>
                <spring:message code="tablecolumnlineage.page.table_column_lineage_bdre" />
            </title>

            <head>
                <meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
                <title>
                    <spring:message code="common.page.title_bdre_1" />
                </title>
                <script>
            ...
            <body>
                ...
                <div class="page-header">
                    <spring:message code="tablecolumnlineage.page.table_column_lineage" />
                </div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-5 form-group">
                                                ...
                                                <label>
                                                    <spring:message code="tablecolumnlineage.page.table_name" />
                                                </label>
                                            ...
                                            <div class="col-xs-5 form-group">
                                                ...
                                                <label>
                                                    <spring:message code="tablecolumnlineage.page.column_name" />
                                                </label>
                ...
                <div id="div-dialog-warning" title="Process Not Found" style="display:none;">
                    ...
                    <p><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span>
                        <spring:message code="tablecolumnlineage.page.process_not_found" />
                    </p>
