...
CREATE TABLE STATISTICSDB (UNIQID INT NOT NULL AUTO_INCREMENT, VALUE BIGINT, NAME VARCHAR(255), PRIMARY KEY (UNIQID))ENGINE=INNODB DEFAULT CHARSET=UTF8;

CREATE TABLE PENDINGURLSDB (UNIQID INT NOT NULL AUTO_INCREMENT, PID BIGINT, INSTANCEEXECID BIGINT, URL VARCHAR(3000), DOCID INT NOT NULL, PARENTDOCID INT NOT NULL, PARENTURL VARCHAR(1000), DEPTH SMALLINT NOT NULL, DOMAIN VARCHAR(255), SUBDOMAIN VARCHAR(255), PATH VARCHAR(1000), ANCHOR VARCHAR(255),PRIORITY TINYINT NOT NULL, TAG VARCHAR(255), PRIMARY KEY (UNIQID))ENGINE=INNODB DEFAULT CHARSET=UTF8;

CREATE TABLE WEBURLSDB (UNIQID INT NOT NULL AUTO_INCREMENT, PID BIGINT, INSTANCEEXECID BIGINT, URL VARCHAR(3000), DOCID INT NOT NULL, PARENTDOCID INT NOT NULL, PARENTURL VARCHAR(1000), DEPTH SMALLINT NOT NULL, DOMAIN VARCHAR(255), SUBDOMAIN VARCHAR(255), PATH VARCHAR(1000), ANCHOR VARCHAR(255),PRIORITY TINYINT NOT NULL, TAG VARCHAR(255), PRIMARY KEY (UNIQID)) ENGINE=INNODB DEFAULT CHARSET=UTF8;
