...
CREATE  TABLE MODELS (
  ...
  MESSAGE_NAME VARCHAR(45) NOT NULL ,
  CONTINUOUS_FEATURES VARCHAR(2049) NOT NULL,
  CATEGORICAL_FEATURES VARCHAR(2049) NOT NULL ,
  PRIMARY KEY (MODEL_NAME),
   CONSTRAINT MODEL_MESSAGE_CONSTRAINT FOREIGN KEY (MESSAGE_NAME) REFERENCES MESSAGES(MESSAGE_NAME) ON DELETE NO ACTION ON UPDATE NO ACTION
)ENGINE=INNODB DEFAULT CHARSET=UTF8;
...
CREATE TABLE MODEL_PROPERTIES (
     ...
     PROP_VALUE VARCHAR(1024),
     DESCRIPTION VARCHAR(1024),
     PRIMARY KEY (MODEL_NAME,PROP_KEY),
     CONSTRAINT MODEL_PROPERTIES_CONSTRAINT FOREIGN KEY (MODEL_NAME) REFERENCES MODELS(MODEL_NAME) ON DELETE NO ACTION ON UPDATE NO ACTION
)ENGINE=INNODB DEFAULT CHARSET=UTF8;