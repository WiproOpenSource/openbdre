...
CREATE TABLE ADQ_STATUS (
  ADQ_STATE SMALLINT NOT NULL,
  DESCRIPTION VARCHAR(45) NOT NULL,
  PRIMARY KEY (ADQ_STATE)
) ENGINE=INNODB DEFAULT CHARSET=UTF8;


CREATE TABLE ADQ (
  ADQ_ID BIGINT(20) NOT NULL AUTO_INCREMENT,
  PROCESS_ID INT(11) NOT NULL,
  USERNAME VARCHAR(45) NOT NULL,
  ...
  ADQ_STATE SMALLINT NOT NULL,
  PRIMARY KEY (ADQ_ID),
  CONSTRAINT PROCESS_ID_ADQ FOREIGN KEY (PROCESS_ID) REFERENCES PROCESS(PROCESS_ID) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT ADQ_USER FOREIGN KEY (USERNAME) REFERENCES USERS(USERNAME) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT ADQ_STATE FOREIGN KEY (ADQ_STATE) REFERENCES ADQ_STATUS(ADQ_STATE) ON DELETE NO ACTION ON UPDATE NO ACTION
