...
#copy generated jar for Data Quality
hdfs dfs -put BDRE/dq/target/dq-$bdreVersion-jar-with-dependencies.jar $hdfsPath/wf/$busDomainId/$processTypeId/$processId/lib/ 
if [ $? -eq 1 ] 
then exit 1
fi
