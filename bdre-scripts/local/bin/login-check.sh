...
curl -L -c cookies.txt -b cookies.txt "$base_url/auth/j_spring_security_check" -H "Pragma: no-cache" -H "Origin: $base_url" -H "Accept-Encoding: gzip, deflate" -H "Accept-Language: en-US,en;q=0.8" -H "Upgrade-Insecure-Requests: 1" -H "User-Agent: Mozilla/5.0 (Windows NT 6.3; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/48.0.2564.116 Safari/537.36" -H "Content-Type: application/x-www-form-urlencoded" -H "Accept: text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8" -H "Cache-Control: no-cache" -H "Referer: $base_url/auth/bdre/security/login.page" -H "Connection: keep-alive" --data "username=$username&password=$password" --compressed
