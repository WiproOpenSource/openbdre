...
public class MigrationPreprocessor extends BaseStructure{
    ...
    private MigrationPreprocessorInfo prepareMigrate(String processId, String instanceExecId) throws Exception {
        ...
        String sourceNameNodeAddress="hdfs://sandbox.hortonworks.com:8020";
        String destNameNodeAddress="hdfs://sandbox.hortonworks.com:8020";
        String sourceJobTrackerAddress="sandbox.hortonworks.com:8050";
        String destJobTrackerAddress="sandbox.hortonworks.com:8050";
        String sourceHiveConnection="jdbc:hive2://sandbox.hortonworks.com:10000";
