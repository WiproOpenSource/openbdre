...
public class FileMoniterAPI {
    ...
    RestWrapper createFileMonitorProperties(@ModelAttribute("fileMonitorInfo")
        ...
        Process childProcess = Dao2TableUtil.buildJPAProcess(27, "subProcess of " + fileMonitorInfo.getProcessName(), "subProcess of " + fileMonitorInfo.getProcessDescription(), 0,fileMonitorInfo.getBusDomainId());
