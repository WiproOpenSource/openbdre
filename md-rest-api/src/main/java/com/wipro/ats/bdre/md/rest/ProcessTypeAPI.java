...
public class ProcessTypeAPI extends MetadataAPIBase {
    ...
    @RequestMapping(value = {"/options_batchSource/{ptid}"}, method = RequestMethod.POST)
    @ResponseBody public
    RestWrapperOptions options_batchSource(@PathVariable("ptid") Integer processTypeId) {
    ...
    @RequestMapping(value = {"/options_batchOperator/{ptid}"}, method = RequestMethod.POST)
    @ResponseBody public
    RestWrapperOptions options_batchOperator(@PathVariable("ptid") Integer processTypeId) {
