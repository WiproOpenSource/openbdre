...
/**
 * ArchiveConsumpQueue generated by hbm2java
 */
@Entity
...
public class ArchiveConsumpQueue  implements java.io.Serializable {
    ...
    public ArchiveConsumpQueue() {
    }

	
    public ArchiveConsumpQueue(Long sourceBatchId, Date insertTs, Integer batchState, Integer processId) {
        this.sourceBatchId = sourceBatchId;
        this.insertTs = insertTs;
        this.batchState = batchState;
        this.processId = processId;
    }
    public ArchiveConsumpQueue(Long sourceBatchId, Long targetBatchId, Date insertTs, Integer sourceProcessId, Date startTs, Date endTs, Integer batchState, String batchMarking, Integer processId) {
       this.sourceBatchId = sourceBatchId;
