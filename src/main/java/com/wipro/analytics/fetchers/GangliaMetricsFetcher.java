...
public class GangliaMetricsFetcher {
    ...
    private final static String CLUSTER_NAME = "MyCluster";
    private final static String GANGLIA_WEBSERVER_HOSTNAME = "localhost";
    private final static int STARTING_FETCH_INTERVAL_FROM_GANGLIA = 3600;
    private final static String gangliaMetricFile = "/home/cloudera/gangliametrics";
    private static final String lineSeparator = "\n";
    private static final String gangliaMetricsTable = "GANGLIA_METRICS";
     ...
     /*   ObjectMapper mapper = new ObjectMapper(new YAMLFactory());
        ...
        */
        ...
        try {
            ...
            String[] listOfMetrics = {"cpu_user", "disk_free", "mem_free", "bytes_in", "bytes_out"};
            ...
            for (String metric : listOfMetrics) {
                ...
                System.out.println("currentEpochTimeInSeconds = " + currentEpochTimeInSeconds);
                System.out.println("fetchStartTime = " + fetchStartTime);
